 ...
 * it is appropriate only for successful functions but still has no return
 * value.
 *
 ...
 * Use for instances where the return value of a function can either be an
 * integer or an error code. This is appropriate for functions that can return a
